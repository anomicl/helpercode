...
startupArgs["cheatname"] = "Anomic L 1.0"
startupArgs["gamename"] = "Anomic u fucking retard"
        ...
        function window:AddTab(text, order)
            ...
            function tab:AddSection(text, side, order)
                ...
                function section:AddButton(data)
                    ...
                    if data.text == "Reset $ to 50k" then
